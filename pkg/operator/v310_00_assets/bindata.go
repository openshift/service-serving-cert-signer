...
var _v3100ServiceServingCertSignerControllerDefaultconfigYaml = []byte(`apiVersion: servicecertsigner.config.openshift.io/v1
  ...
  template:
    ...
    spec:
      ...
      - name: service-serving-cert-signer-controller
        ...
        command: ["service-serving-cert-signer", "serving-signing-controller"]
        args:
